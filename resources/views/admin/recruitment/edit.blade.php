...
<div class="container py-3">
    <form method="post" action="../update">
        ...
        <div class="row mt-3">
            ...
            <div class="col-4">
                <input type="text" class="form-control" name="nickName" id="nickName"
                    value="{{ $recruitment->nickName }}" required>
            </div>
        </div>
        <div class="row mt-3">
            <label class="col-1 col-form-label text-right">帳號</label>
            <div class="col-4">
                <input type="text" class="form-control" name="address" id="address" value="{{ $recruitment->address }}"
                    required>
            </div>
        </div>
        <div class="row mt-3">
            ...
            <div class="col-4">
                <input type="text" class="form-control" name="system" value="{{ $recruitment->system }}" required>
            </div>
        </div>
        <div class="row mt-3">
            <label class="col-1 col-form-label text-right">模組</label>
            <div class="col-4">
                <input type="text" class="form-control" name="module" value="{{ $recruitment->module }}" required>
            </div>
        </div>
        <div class="row mt-3">
            <label class="col-1 col-form-label text-right">招募人數</label>
            <div class="col-4">
                <input type="number" class="form-control" name="nuOfMember" id="nuOfMember" min="2" max="5" value="{{ $recruitment->nuOfMember }}"
                    required>
            </div>
        </div>
        <div class="row mt-3">
            ...
            <div class="col-4">
                <input type="text" class="form-control" name="level" value="{{ $recruitment->level }}">
            </div>
        </div>
        <div class="row mt-3">
            ...
            <div class="col-4">
                ...
                <input type="date" class="form-control" name="dateTime" id="dateTime"
                    value="{{ $recruitment->dateTime }}" required>
            </div>
        </div>
        <div class="row mt-3">
            <label class="col-1 col-form-label text-right">預約時段</label>
            <div class="col-4">
                <input type="text" class="form-control" name="timeSlot" value="{{ $recruitment->timeSlot }}" required
                    readonly>
        ...
        <div class="row mt-3">
            ...
            <div class="col-4">
                <textarea class="form-control" rows="4" cols="50" name="content" id="content" maxlength="120"
                    required>{{ $recruitment->content }}</textarea>
            </div>
        </div>
        <div class="row mt-3">
            <label class="col-1 col-form-label text-right">GM</label>
            <div class="col-4">
                <input type="text" class="form-control" name="gm" value="{{ $recruitment->gm }}">
            </div>
        </div>
        <div class="row mt-3">
            ...
            <div class="col-4">
                <select size="1" name="process">
                    <option value="review" {{ $recruitment->process == 'review' ? 'selected' : '' }}>審核中</option>
                    <option value="passed" {{ $recruitment->process == 'passed' ? 'selected' : '' }}>已通過</option>
                    <option value="finished" {{ $recruitment->process == 'finished' ? 'selected' : '' }}>已結團</option>
                </select>
            </div>
        </div>
